...
class Kadid10k(Dataset):
    def __init__(self, transform=None, is_split=False, num_split=2, is_train=True):
        self.ref_path = r'E:\dataset\datasets\train\Kadid10k\images'
        self.dist_path = r'E:\dataset\datasets\train\Kadid10k\images'
        self.label_file = 'Kadid10k_label.csv'
        # 数据集的取值范围
        self.max_score = 5
        self.min_score = 1
        ...
        #     self.random_split_pkl = 'tid2013_random20_num_split10.pkl'  # 10次随机划分文件
...
if __name__ == '__main__':
    ...
    # tid2013 = Kadid10k(transform=transforms, is_split=True, is_train=False)
    # tid2013 = Kadid10k(transform=transforms, is_split=True)  # 620
    tid2013 = Kadid10k(transform=transforms)  # 10125
